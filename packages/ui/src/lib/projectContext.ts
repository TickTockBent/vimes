...
//
//   vimes.example.com/                            → the picker (D42's landing)
//   vimes.example.com/infrastructure/johnny/      → that project, last layout
//   vimes.example.com/infrastructure/johnny/#/session/x  → a deep link in it
//
